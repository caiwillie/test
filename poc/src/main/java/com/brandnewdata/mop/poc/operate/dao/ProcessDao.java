...
import com.brandnewdata.mop.poc.operate.po.ProcessPo;
...
public class ProcessDao extends AbstractDao {
    ...
    public ProcessPo getOne(Query query) {
        SearchRequest searchRequest = new SearchRequest.Builder()
                .index(processIndex.getFullQualifiedName())
                .query(query)
                .build();

        return ElasticsearchUtil.searchOne(client, searchRequest, ProcessPo.class);
    }
