...
public interface QNameConstants {
    ...
    QName BPMN_CONDITION_EXPRESSION_QNAME = DocumentHelper.createQName(CONDITION_EXPRESSION_LOCALNAME, BPMN_NAMESPACE);

    QName BPMN_T_FORMAL_EXPRESSION_QNAME = DocumentHelper.createQName(T_FORMAL_EXPRESSION_LOCALNAME, BPMN_NAMESPACE);
    ...
    QName BRANDNEWDATA_RESPONSE_MAPPING_QNAME = DocumentHelper.createQName(RESPONSE_MAPPING_LOCALNAME, BRANDNEWDATA_NAMESPACE);

    QName BRANDNEWDATA_REQUEST_QNAME = DocumentHelper.createQName(REQUEST_LOCALNAME, BRANDNEWDATA_NAMESPACE);

    QName BRANDNEWDATA_RESPONSE_QNAME = DocumentHelper.createQName(RESPONSE_LOCALNAME, BRANDNEWDATA_NAMESPACE);
    // zeebe
