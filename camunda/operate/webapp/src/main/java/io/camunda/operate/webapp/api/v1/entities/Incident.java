...
public class Incident {
   ...
   public static final Map OBJECT_TO_ELASTICSEARCH = Map.of("type", "errorType", "message", "errorMessage");
   private Long key;
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.key, this.processDefinitionKey, this.processInstanceKey, this.type, this.message, this.creationTime, this.state});
   }
