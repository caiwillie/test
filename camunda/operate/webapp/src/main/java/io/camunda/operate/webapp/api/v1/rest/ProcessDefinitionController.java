...
@Validated
public class ProcessDefinitionController extends ErrorController implements SearchController {
   ...
   name = "Sort and page",
   value = "{   \"size\": 5,    \"sort\": [{\"field\":\"name\",\"order\": \"ASC\"}],    \"searchAfter\": [      \"Called Process\",      \"2251799813687281\"  ] }",
   ...
   value = "{   \"filter\": {      \"version\": 1    },    \"size\": 50,    \"sort\": [{\"field\":\"bpmnProcessId\",\"order\": \"ASC\"}]}",
   ...
   public ProcessDefinition byKey(@Parameter(description = "Key of process definition",required = true) @PathVariable @Valid Long key) {
   ...
   public String xmlByKey(@Parameter(description = "Key of process definition",required = true) @PathVariable @Valid Long key) {
