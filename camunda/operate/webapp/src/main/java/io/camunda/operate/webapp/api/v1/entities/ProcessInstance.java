...
public class ProcessInstance {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.key, this.processVersion, this.bpmnProcessId, this.parentKey, this.startDate, this.endDate, this.state, this.processDefinitionKey});
   }
