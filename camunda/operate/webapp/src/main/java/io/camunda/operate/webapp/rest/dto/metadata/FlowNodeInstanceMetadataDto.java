...
public class FlowNodeInstanceMetadataDto {
   ...
   public int hashCode() {
      return Objects.hash(new Object[]{this.flowNodeId, this.flowNodeInstanceId, this.flowNodeType, this.startDate, this.endDate, this.calledProcessInstanceId, this.calledProcessDefinitionName, this.calledDecisionInstanceId, this.calledDecisionDefinitionName, this.eventId, this.jobType, this.jobRetries, this.jobWorker, this.jobDeadline, this.jobCustomHeaders});
   }
