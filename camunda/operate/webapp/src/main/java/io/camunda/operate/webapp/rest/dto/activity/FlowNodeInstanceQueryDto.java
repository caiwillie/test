...
public class FlowNodeInstanceQueryDto {
   ...
   @ApiModelProperty(
      value = "Array of two strings: copy/paste of sortValues field from one of the operations.",
   ...
   public int hashCode() {
      int result = Objects.hash(new Object[]{this.processInstanceId, this.treePath, this.pageSize});
